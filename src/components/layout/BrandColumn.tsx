    ...
    <Aside id="brand-column" data-scope="desktop-only">
      <Inner>
        ...
        <QuizSection aria-label="향 취향 퀴즈">
          ...
          <DecoImage className="brand-column__deco-hand" src="/org/img/hand.png" alt="" />
        </QuizSection>
        ...
        <DownloadSection aria-label="앱 다운로드 배너">
          ...
          <Badges>
            <a href="#"><img src="/org/img/badge-appstore.png" alt="Download on the App Store" /></a>
            <a href="#"><img src="/org/img/badge-googleplay.png" alt="Get it on Google Play" /></a>
          </Badges>
        </DownloadSection>
      </Inner>

      <DecoImage className="brand-column__deco--fabric" src="/org/img/deco-fabric.png" alt="" />
      <DecoImage className="brand-column__deco--bag" src="/org/img/deco-bag.png" alt="" />
      <DecoImage className="brand-column__watermark" src="/org/img/brand-watermark.png" alt="" />
    </Aside>
  );
};
